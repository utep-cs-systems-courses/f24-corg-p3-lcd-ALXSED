...
void lights(int change){
  if(change == 1){
    fillRectangle(0,0,screenWidth,screenHeight,COLOR_BLUE);
    drawString11x16(20,60,"WEEEEE", COLOR_BLACK,COLOR_BLUE);
  }else{
    fillRectangle(0,0,screenWidth,screenHeight,COLOR_RED);
    drawString11x16(20,60,"WOOOOO", COLOR_BLACK,COLOR_RED);
  }
}
